...
# emitente
emitente = Emitente(
    razao_social='LUCIA HELENA DA SILVA BATISTA ME',
    cnpj='01597994000138',           # cnpj apenas números
    nome_fantasia = 'Restaurante Marinheiros',
    codigo_de_regime_tributario='1', # 1 para simples nacional ou 3 para normal
    inscricao_estadual='254282601', # numero de IE da empresa
    endereco_logradouro='Avenida Epitácio Bittencourt',
    endereco_numero='640',
    endereco_bairro='Praia Brava',
    endereco_municipio='Florianópolis',
    endereco_uf='SC',
    endereco_cep='88056780',
...
#    cliente=cliente,
   ...
   serie='1',
   numero_nf='121',           # Número do Documento Fiscal.
...
# csc de homologação
csc = '494A2ED7-1D8E-407F-8DE1-5821100A2611'
